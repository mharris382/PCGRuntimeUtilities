...
class ISMRUNTIMEPHYSICS_API AISMPhysicsActor : public AActor, public IISMPoolable
{
    GENERATED_BODY()
...
public:
    ...
    /**
     * Play conversion sound at actor location.
     * Only plays if ConversionSound is set in data asset.
     */
    void PlayConversionSound();
    
    /**
     * Play return sound at actor location.
     * Only plays if ReturnSound is set in data asset.
     */
